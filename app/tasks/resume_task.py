...
@shared_task(bind=True, name="resume_pipeline")
def resume_pipeline_task(self, job_id: str, from_step: str) -> dict[str, str]:
    ...
    try:
        ...
        logger.info("Pipeline completed for job %s: %s", job_id, result.output_path)
